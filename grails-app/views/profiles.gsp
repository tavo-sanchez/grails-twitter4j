...
<html>
  ...
  <div class="body">
      <div class="dialog">
  <table><tr><td>
      <g:link controller="twitter4jtest" action="profiles" params="['tipo':'friends']">Friends</g:link>&nbsp;|&nbsp;
        <g:link controller="twitter4jtest" action="profiles" params="['tipo':'followers']">Followers</g:link>

  </td></tr></table>

  <br><br>
     <center>  <h1>${tipoProfiles}</h1>
</center>
          <table>
